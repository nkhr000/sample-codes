/*******************************************************************************
Ref: https://github.com/awslabs/amazon-redshift-utils/blob/master/src/AdminScripts/copy_performance.sql
Purpose: Return COPY information from past 1 days
Columns:
...
where s.end_Time >=  dateadd(day, -1, current_Date)
